...
class PDFBridgeTest extends TestCase
{
    ...
    public function test_get_available_converters(): void
    {
    ...
    public function test_convert_text_with_empty_input(): void
    {
    ...
    public function test_convert_html_with_valid_input(): void
    {
    ...
    public function test_convert_csv_with_valid_input(): void
    {
        $csv = "Name,Age,City\nJohn,25,New York\nJane,30,Los Angeles\nBob,35,Chicago";
    ...
    public function test_convert_csv_with_invalid_input(): void
    {
        $this->expectException(ValidationException::class);
    ...
    public function test_unsupported_file_extension(): void
    {
    ...
    public function test_convert_file_with_text_file(): void
    {
    ...
    public function test_convert_file_with_html_file(): void
    {
